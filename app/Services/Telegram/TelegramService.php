...
class TelegramService
{
    ...
    {
        $message = 'Новый заказ на сайте.' . $order->status === Order::STATUS_PAID ? 'Заказ оплачен' : 'Заказ не оплачен' . 'Ссылка на заказ - http://dostavka-panorama.ru/order-telegram/' . $order->id;
